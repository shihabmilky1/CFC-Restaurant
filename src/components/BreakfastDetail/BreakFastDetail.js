...
const BreakFastDetail = () => {
    ...
    const addCarts = {food:breakfastFood,quantity,...loginUser} 
            ...
            <div className="container">
                <div className="row mt-5">
                    <div className="col-md-6">
                        <h2>{breakfastFood.name}</h2>
                        <br/>
                        <p>{breakfastFood.description}</p>
                        <div className="d-flex align-items-center">
                        <h2>$ {breakfastFood.price}</h2>
                        <div>
                        ...
                        <button onClick={()=>handleCart(breakfastFood)} className="btn btn-cart"><FontAwesomeIcon className="me-2" icon={faCartPlus} />Add</button>
                    </div>
                    <div className="col-md-6">
                        <img src={breakfastFood.image} className="w-100" alt=""/>
                    </div>
                </div>
            </div>
            <Footer></Footer>
